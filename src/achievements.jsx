      ...
      <div className="hackathonPage">
        {hackDetails ? (
          hackDetails.map((details, index) => (
            ...
            >
              <div>
                <h5>Hackathon Name : {details.name}</h5>
              </div>
              <div>
                <h5>Organizer : {details.organizer}</h5>
              </div>
              <div>
                <p>Achievement : {details.Achievement}</p>
              </div>
              <div>
                <p href={details.repoLink}>Project : {details.project}</p>
              </div>
              <div className="icons">
                <div>
